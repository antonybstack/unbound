...
**MVP (slices 0–3) is playable.** Predicted WASD and swing start, sheathe/draw camera, three loadouts, a dummy with a readable windup, 1v1 PvP, and a `character` row that keeps XP after you leave the yard.
