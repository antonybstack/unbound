...
| **1 — three loadouts** | Playable | Sword, bow, staff (`1/2/3`). Stamina, light/heavy, dodge i-frames in the roll (ghosted), frontal block (chip + hold) that guard-breaks at 0 stam. Dummy holds a pocket and winds a club (heavy under 70 HP) through pokes; heavies have hyperarmor; stam waits out the swing. Client predicts swing start and the bolt leaving the bow; bows/staffs aim with camera pitch; hits shake the camera. |
